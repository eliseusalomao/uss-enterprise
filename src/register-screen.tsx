...
export function RegisterScreen ({ handlePanel }: { handlePanel: () => void }) {
            ...
            <div className="h-full w-full fixed inset-0 bg-black font-pc text-yellow-500 flex justify-center items-center">
                <div className="h-[720px] w-[720px]">
                    ...
                    <div className="flex flex-col gap-7 py-4 text-lg">
                        ...
                        <input name="password" value={newCrewMember.password} className="w-full bg-transparent outline-none" type="text" placeholder="Senha" onChange={e => handleForm(e)} />
